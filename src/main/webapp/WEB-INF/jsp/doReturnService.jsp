...
<div style="margin:20px 0;"></div>
    <table class="easyui-datagrid" title="反馈服务" style="width:85%;height:50%"
    ...
    <div style="padding:10px 60px 20px 60px">
        <form id="ff" action="doReturnService" method="post">
            <table cellpadding="5">
                <tr>
                    <td>处理结果:</td>
                    <td>
                        <input class="easyui-textbox" type="text"  name="svrResult"
                ...
                <tr>
                    <td> 客户满意度:</td>
                    <td>
                        <select id="satisfyValue"  name="satisfyValue" panelHeight="auto" style="width:160px" >
                            <option value="">----请选择---</option>
                            <c:forEach  items="${satisfyList}" var="sf" varStatus="m" >
                                <option value="${m.count}" <c:if test="${s.svrSatisfy==sf.text}">selected="selected"</c:if> >
                                        ${sf.text}
                                </option>
                            </c:forEach>
                        </select>
