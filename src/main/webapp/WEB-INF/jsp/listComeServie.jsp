...
<table class="easyui-datagrid" title="归档服务" style="width:100%;height:80%"
    ...
    <tr>
       <%-- <th data-options="field:'productid',width:20,align:'center'">ID </th>--%>
        <th data-options="field:'listprice',width:100,align:'center'">服务类型</th>
        <th data-options="field:'attr1',width:300,align:'center'">概要</th>
      ...
      <c:forEach items="${serviceList}" var="s" varStatus="m">
          <tr>
             <%-- <td data-options="field:'productid',width:20,align:'center'">
              ...
              <td data-options="field:'listprice',width:100,align:'center'">
                  ${s.svrType}
              </td>
              <td data-options="field:'attr1',width:300,align:'center'">${s.svrTitle}</td>
