...
<table class="easyui-datagrid" title="处理服务" style="width:100%;height:80%"
      ...
      <c:forEach items="${serviceList}" var="s" varStatus="m">
          <tr>
              ...
              <td data-options="field:'lmm',width:90,align:'center'">
                  <a href="toDealServiceJsp?svrId=${s.svrId}"
...
<script type="text/javascript">
    ...
    function doShare(svrId,selectId){
        ...
        var svrDealId=selectObj.value;
        var svrDealBy=selectObj.options[selectObj.options.selectedIndex].text;
